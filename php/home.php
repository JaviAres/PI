   ...
   <div class="container-fluid">
      <div class="row">
        <div class="col" id="merchandising">
          <h2 id="titulo_menu">El inventario</h2>
          <hr>
        <div class="row">
        <div class="content">
            <a href="../utiles_php/busqueda.php">
            <div class="content-overlay"></div>
            <img class="content-image" src="../images/albazplaymat.png" id="imagen_merchandising" alt="imagen menu merchandising">
            <div class="content-details fadeIn-bottom">
              <h3 class="content-title">Nuestro Inventario</h3>
              <p class="content-text">¡Mira todo lo que podemos ofrecerte!</p>
            </div>
            </a>
        </div></div>
        </div>
